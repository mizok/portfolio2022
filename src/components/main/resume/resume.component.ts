      ...
      units: [
        {
          ...
          unitDescrp: '我在大學念的是土木系，土木系的教育對我來說最大的意義是數學/物理計算的知識與熟練度，這部份其實在日後對我產生很大的影響，尤其是規劃網頁動畫細節的部分。'
        },
        {
          positionTitle: '研究所',
          positionDescrp: '2014~2017',
          unitTitle: '輔仁大學 FJU 應用美術所',
          unitDescrp: '當初之所以會選擇從理組轉換跑道到美術系，是因為心裡有對於美術/設計的嚮往，而這段經歷最終也造就了一般前端工程師所不具備的能力與興趣導向。'
        }
      ]
    }, {
